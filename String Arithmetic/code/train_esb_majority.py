...
sys.stdout = open('5-plusminus_real_test(1).txt', 'w')
...
trainer.plot_loss(num[0], '5', 'real')
trainer2.plot_loss(num[1], '5', 'real')
trainer3.plot_loss(num[2], '5', 'real')
trainer4.plot_loss(num[3], '5', 'real')
trainer5.plot_loss(num[4], '5', 'real')
...
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('5-plusminus_real.png')
plt.show()