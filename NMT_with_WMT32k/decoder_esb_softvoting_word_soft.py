...
# dropout & alpha
# nohup python decoder_esb_softvoting_word_soft.py --translate --data_dir ./wmt32k_data --model_dir ./outputs_dropout --eval_dir ./deu-eng --alpha_esb &
...
def main():
    ...
    f = open('./evaluation/esb/consensus_loss/word_settled_soft_loss/hpys.txt', 'w')
