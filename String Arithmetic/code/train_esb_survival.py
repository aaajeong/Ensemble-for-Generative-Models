...
sys.stdout = open('5-plusminus_survival_test(1).txt', 'w')
...
trainer.plot_loss(num[0], '5', 'survival')
trainer2.plot_loss(num[1], '5', 'survival')
trainer3.plot_loss(num[2], '5', 'survival')
trainer4.plot_loss(num[3], '5', 'survival')
trainer5.plot_loss(num[4], '5', 'survival')
...
plt.ylabel('Accuracy')
plt.ylim(0, 1.0)
plt.savefig('5-plusminus_survival.png')
plt.show()